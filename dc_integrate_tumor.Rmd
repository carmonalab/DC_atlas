...
```{r}
#only tumor samples
seurat.list <- seurat.list[(c("qian","qianbc","qiancrc","qianlung","qianovarian","zhang","zhangcrc","zilionis"))]
```
...
ggsave("plots/Gerhard_tumor_STACAS_unsup.pdf", height = 5, width=10)
```
