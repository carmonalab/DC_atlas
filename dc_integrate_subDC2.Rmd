...
object_integrated$annotation[object_integrated$seurat_clusters %in% c("3")] <- "cDC2_CD1A_A"
object_integrated$annotation[object_integrated$seurat_clusters %in% c("7")] <- "cDC2_CD1A_B"
...
p2 <- DimPlot(ref, reduction="umap", group.by="scGate_multi") + theme(aspect.ratio = 1)
p1 | p2
...
genes <- c("PRDM16","ACY3","PPP1R14A","AXL","CLEC9A","XCR1","CADM1","CD1A","CD207","CLEC10A","CD1C",
                 "LAMP3","CCR7","FSCN1","S100A8","S100A9","VCAN","FCN1",
                 "GZMB","LILRA4","TCF4","ITGAX","CD3E","CD3D","CD3G","TRBC2","CD2","TRAC","LCK","CD7","KLRB1")
